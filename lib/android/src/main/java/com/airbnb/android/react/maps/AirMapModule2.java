...
public class AirMapModule2 extends ReactContextBaseJavaModule {
  ...
  public AirMapModule2(ReactApplicationContext reactContext) {
    super(reactContext);
  }

  @Override
  public String getName() {
    return "AirMapModule2";
  }
  ...
  public void takeSnapshot(final int tag, final ReadableMap options, final Promise promise) {
    ...
    uiManager.addUIBlock(new UIBlock() {
      public void execute(NativeViewHierarchyManager nvhm) {
        AirMapView2 view = (AirMapView2) nvhm.resolveView(tag);
        if (view == null) {
          promise.reject("AirMapView2 not found");
          return;
        }
        if (view.map == null) {
          promise.reject("AirMapView2.map is not valid");
          return;
        }
