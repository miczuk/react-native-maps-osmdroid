...
public class AirMapOverlay2 extends AirMapFeature2 implements ImageReadable2 {
  ...
  private final ImageReader2 mImageReader2;
  private GoogleMap map;

  public AirMapOverlay2(Context context) {
    super(context);
    this.mImageReader2 = new ImageReader2(context, getResources(), this);
  }
  ...
  public void setImage(String uri) {
    this.mImageReader2.setImage(uri);
  }
