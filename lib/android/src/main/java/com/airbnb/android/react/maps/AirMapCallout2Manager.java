...
public class AirMapCallout2Manager extends ViewGroupManager<AirMapCallout2> {

  @Override
  public String getName() {
    return "AirMapCallout2";
  }

  @Override
  public AirMapCallout2 createViewInstance(ThemedReactContext context) {
    return new AirMapCallout2(context);
  }

  @ReactProp(name = "tooltip", defaultBoolean = false)
  public void setTooltip(AirMapCallout2 view, boolean tooltip) {
  ...
  @Override
  public void updateExtraData(AirMapCallout2 view, Object extraData) {
