...
public class AirMapManager2 extends ViewGroupManager<AirMapView2> {
  ...
  public AirMapManager2(ReactApplicationContext context) {
  ...
  @Override
  protected AirMapView2 createViewInstance(ThemedReactContext context) {
    return new AirMapView2(context, this.appContext, this, googleMapOptions);
  }
  ...
  public void setRegion(AirMapView2 view, ReadableMap region) {
    view.setRegion(region);
  }

  @ReactProp(name = "initialRegion")
  public void setInitialRegion(AirMapView2 view, ReadableMap initialRegion) {
    view.setInitialRegion(initialRegion);
  }

  @ReactProp(name = "camera")
  public void setCamera(AirMapView2 view, ReadableMap camera) {
    view.setCamera(camera);
  }

  @ReactProp(name = "initialCamera")
  public void setInitialCamera(AirMapView2 view, ReadableMap initialCamera) {
  ...
  public void setMapPadding(AirMapView2 view, @Nullable ReadableMap padding) {
    int left = 0;
    int top = 0;
    int right = 0;
    int bottom = 0;
  ...
  public void setHandlePanDrag(AirMapView2 view, boolean handlePanDrag) {
  ...
  public void setMoveOnMarkerPress(AirMapView2 view, boolean moveOnPress) {
    view.setMoveOnMarkerPress(moveOnPress);
  }

  @ReactProp(name = "loadingBackgroundColor", customType = "Color")
  public void setLoadingBackgroundColor(AirMapView2 view, @Nullable Integer loadingBackgroundColor) {
  ...
  public void setPitchEnabled(AirMapView2 view, boolean pitchEnabled) {
    view.map.getUiSettings().setTiltGesturesEnabled(pitchEnabled);
  }

  @ReactProp(name = "minZoomLevel")
  public void setMinZoomLevel(AirMapView2 view, float minZoomLevel) {
    view.map.setMinZoomPreference(minZoomLevel);
  }

  @ReactProp(name = "maxZoomLevel")
  public void setMaxZoomLevel(AirMapView2 view, float maxZoomLevel) {
    view.map.setMaxZoomPreference(maxZoomLevel);
  }

  @ReactProp(name = "kmlSrc")
  public void setKmlSrc(AirMapView2 view, String kmlUrl) {
    if (kmlUrl != null) {
  ...
  @Override
  public void receiveCommand(AirMapView2 view, int commandId, @Nullable ReadableArray args) {
    Integer duration;
    Double lat;
    Double lng;
    Double lngDelta;
  ...
  @Override
  public void addView(AirMapView2 parent, View child, int index) {
    parent.addFeature(child, index);
  }

  @Override
  public int getChildCount(AirMapView2 view) {
    return view.getFeatureCount();
  }

  @Override
  public View getChildAt(AirMapView2 view, int index) {
    return view.getFeatureAt(index);
  }

  @Override
  public void removeViewAt(AirMapView2 parent, int index) {
    parent.removeFeatureAt(index);
  }

  @Override
  public void updateExtraData(AirMapView2 view, Object extraData) {
  ...
  @Override
  public void onDropViewInstance(AirMapView2 view) {
    view.doDestroy();
