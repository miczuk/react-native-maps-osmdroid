...
public class AirMapMarker2Manager extends ViewGroupManager<AirMapMarker2> {
  ...
  @Override
  public AirMapMarker2 createViewInstance(ThemedReactContext context) {
    return new AirMapMarker2(context);
  }

  @ReactProp(name = "coordinate")
  public void setCoordinate(AirMapMarker2 view, ReadableMap map) {
    view.setCoordinate(map);
  }

  @ReactProp(name = "title")
  public void setTitle(AirMapMarker2 view, String title) {
    view.setTitle(title);
  }

  @ReactProp(name = "identifier")
  public void setIdentifier(AirMapMarker2 view, String identifier) {
    view.setIdentifier(identifier);
  }

  @ReactProp(name = "description")
  public void setDescription(AirMapMarker2 view, String description) {
...
//    }
  ...
  public void setAnchor(AirMapMarker2 view, ReadableMap map) {
  ...
  public void setCalloutAnchor(AirMapMarker2 view, ReadableMap map) {
  ...
  public void setImage(AirMapMarker2 view, @Nullable String source) {
...
//    }
  ...
  @ReactProp(name = "icon")
  public void setIcon(AirMapMarker2 view, @Nullable String source) {
    view.setImage(source);
  }

  @ReactProp(name = "pinColor", defaultInt = Color.RED, customType = "Color")
  public void setPinColor(AirMapMarker2 view, int pinColor) {
  ...
  public void setMarkerRotation(AirMapMarker2 view, float rotation) {
    view.setRotation(rotation);
  }

  @ReactProp(name = "flat", defaultBoolean = false)
  public void setFlat(AirMapMarker2 view, boolean flat) {
    view.setFlat(flat);
  }

  @ReactProp(name = "draggable", defaultBoolean = false)
  public void setDraggable(AirMapMarker2 view, boolean draggable) {
  ...
  public void setOpacity(AirMapMarker2 view, float opacity) {
    super.setOpacity(view, opacity);
    view.setOpacity(opacity);
  }

  @ReactProp(name = "tracksViewChanges", defaultBoolean = true)
  public void setTracksViewChanges(AirMapMarker2 view, boolean tracksViewChanges) {
    view.setTracksViewChanges(tracksViewChanges);
  }

  @Override
  public void addView(AirMapMarker2 parent, View child, int index) {
    // if an <Callout /> component is a child, then it is a callout view, NOT part of the
    // marker.
    if (child instanceof AirMapCallout2) {
      parent.setCalloutView((AirMapCallout2) child);
    } else {
  ...
  @Override
  public void removeViewAt(AirMapMarker2 parent, int index) {
  ...
  @Override
  public void receiveCommand(AirMapMarker2 view, int commandId, @Nullable ReadableArray args) {
    Integer duration;
    Double lat;
    Double lng;
    ReadableMap region;
  ...
  @Override
  public void updateExtraData(AirMapMarker2 view, Object extraData) {
